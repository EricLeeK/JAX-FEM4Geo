...
# Import DP logic from the main script if possible, or redefine locally for self-containment
# To ensure it's identical to your plasticity script, I'll use the same class structure.
